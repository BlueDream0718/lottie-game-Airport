...
const Scene1 = React.forwardRef(({ nextFunc, _baseGeo, _geo, _startTransition }, ref) => {
    ...
    const maskPathList = [
        'Guard checking man mask',
        'Scaner machine mask',
        'Staf mask',
        'Display board mask',
        'Excelater mask',
        'Man sat on chair mask',
        'Pilot and air hostess mask',
        'Pilot mask',
        'teamarket',
        'Two boys mask',
        'Runway mask',
        'Airoplane mask takeoff'
    ]
                ...
                setTimeout(() => {
                    ...
                    setTimeout(() => {
                        if (currentMaskNum == maskPathList.length - 1) {
                            ...
                            currentMaskNum++;
                            blackWhiteObject.current.style.WebkitMaskImage = 'url("' + prePathUrl() + 'images/Introduction/' + maskPathList[currentMaskNum] + '.png")'
        ...
        >
            <div
                ...
                <img
                    ...
                    src={prePathUrl() + "images/Introduction/Airpot BG Black and white.png"}
                />
            </div>
            ...
            <div
                ...
                style={{
                    ...
                    left: '0%',
                    top: '0%',
                    WebkitMaskImage: 'url("' + prePathUrl() + 'images/Introduction/' + maskPathList[currentMaskNum] + '.png")',
                ...
                <img
                    ...
                    src={prePathUrl() + "images/Introduction/Airpot BG.png"}
                />
                <BaseImage
                    ref={airOutLine}
                    url={'Introduction/Intro 13.1.png'}
                    scale={0.684}
                    posInfo={{
                        l: 0.1335, t: 0.0995
                    }}
